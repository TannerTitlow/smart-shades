...
{
    public abstract class SmartShadesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SmartShadesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SmartShadesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SmartShadesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SmartShadesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SmartShadesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SmartShadesDbContext, Task<T>> func)
        {
            T result;
